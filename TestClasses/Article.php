...
class Article
{
     ...
     * @ApiParams(name="id", type="integer", required=false, description="Article id")
     */
    public function get()
    {
     ...
     * @ApiParams(name="title", type="string", required=false, description="Article title")
     * @ApiParams(name="content", type="string", required=false, description="Article content")
     * @ApiParams(name="user_id", type="integer", required=false, description="User id")
     */
